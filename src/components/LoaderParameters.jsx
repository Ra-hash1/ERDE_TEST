...
const apiEndpoints = {
  ...
  'MCU': `${API_BASE_URL}/api/mcu/loader`,
  'Transmission System': `${API_BASE_URL}/api/transmission-system/loader`,
  'DC-DC Converter': `${API_BASE_URL}/api/dc-dc-converter/loader`,
  'LV Battery': `${API_BASE_URL}/api/lv-battery/loader`,
  'HVAC': `${API_BASE_URL}/api/hvac/loader`,
  'Hydraulic System': `${API_BASE_URL}/api/hydraulic-system/loader`,
  'Axle Oil': `${API_BASE_URL}/api/axle-oil/loader`,
  'Vehicle Peripherals': `${API_BASE_URL}/api/vehicle-peripherals/loader`,
  'Operator Switch Board': `${API_BASE_URL}/api/operator-switch-board/loader`,
  'Android Display': `${API_BASE_URL}/api/android-display/loader`,
  'Vehicle Wide Parameters': `${API_BASE_URL}/api/vehicle-wide/loader`,
...
export default LoaderParameters;